...
<Cards>
  ...
  />
  <Card
    href="/docs/api/main/clear-macro-forwarder"
    title="Clear Macro Forwarder"
    description="Clear-signing (EIP-712) forwarder for running user-defined macros as atomic batch operations, with third-party relaying and Permit2 support."
  />
  <Card
    href="/docs/api/main/blind-macro-forwarder"
    title="Blind Macro Forwarder"
    description="Legacy forwarder for running user-defined macros as atomic batch operations (the caller is the operator)."
  />
  <Card
