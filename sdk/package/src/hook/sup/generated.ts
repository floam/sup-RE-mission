...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link lockerAbi}__ and `functionName` set to `"DAO_TREASURY"`
 */
export const useReadLockerDaoTreasury = /*#__PURE__*/ createUseReadContract({
  abi: lockerAbi,
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link lockerAbi}__ and `functionName` set to `"UNLOCKING_FEE"`
 */
export const useReadLockerUnlockingFee = /*#__PURE__*/ createUseReadContract({
  abi: lockerAbi,
