...
| `app/swap/page.tsx`          | `SwapPage`               | Catalog (`page.tsx`) + webpack 6806 |
...
| `config/swap.ts`                      | `SwapCampaignToken`, `SWAP_CAMPAIGN_TOKENS`, `SWAP_REFERRER_ADDRESS`, `SWAP_CAMPAIGN_CHAIN_ID`, `SWAP_REFERRER_SESSION_KEY`                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Behavior 6806                                                           |
