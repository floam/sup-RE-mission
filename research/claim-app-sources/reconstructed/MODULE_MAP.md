...
| `hooks/useMysteryBox.ts`                  | `useMysteryBoxLastClaim`                                                                                                                                                                | Repository-authored compatibility     |
...
| `providers/DailyMysteryBoxProvider.tsx` | `useDailyMysteryBox`, `DailyMysteryBoxClaim`                                                                                                                                                                | Catalog + behavior 327; repository inline UI   |
